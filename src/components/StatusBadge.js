export default function StatusBadge({ status }) {
  const map = {
    ...
    pending: { containerCls: 'bg-amber-50 text-amber-800', dotCls: 'bg-amber-500', label: 'Pending Assignment' },
    pending_assignment: { containerCls: 'bg-amber-50 text-amber-800', dotCls: 'bg-amber-500', label: 'Pending Assignment' },
    in_progress: { containerCls: 'bg-blue-50 text-blue-700', dotCls: 'bg-blue-500', label: 'In Progress' },
    resolved: { containerCls: 'bg-emerald-50 text-emerald-700', dotCls: 'bg-emerald-500', label: 'Resolved' },
    closed: { containerCls: 'bg-slate-100 text-slate-700', dotCls: 'bg-slate-500', label: 'Closed' },
    cancelled: { containerCls: 'bg-rose-50 text-rose-600', dotCls: 'bg-rose-500', label: 'Cancelled' },
